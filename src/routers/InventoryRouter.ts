...
export class InventoryRouter {
	...
	private constructor() {
		...
		this.router.get("/", PermissionMiddleware.require("inventory.view"), InventoryValidator.list, InventoryController.getBalances);
		this.router.get("/movements", PermissionMiddleware.require("inventory.view"), InventoryValidator.movements, InventoryController.getMovements);
		this.router.post("/adjustments", PermissionMiddleware.require("inventory.adjust"), InventoryValidator.adjustment, InventoryController.adjust);
	}
