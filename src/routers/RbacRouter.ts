...
export class RbacRouter {
	...
	private constructor() {
		...
		this.router.post("/roles/:id/apply", AuthGuardMiddleware.requireAuth(), PermissionMiddleware.require("settings.roles.create"), RbacValidator.applyRole, RbacController.applyRole);
